<%@ Page Title="Buy Shares" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BuyShare.aspx.cs" Inherits="SharesBrokeringClient.BuyShare" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %></h2>
    <h4>Choose how many shares you wish to buy.</h4>
    <br />
    <p>
    ...
    <p>
        <asp:Label ID="QuantityAvailableLabel" runat="server" Text="Quantity Available:" Font-Bold="True"></asp:Label>
        <asp:Label ID="QuantityAvailableValueLabel" runat="server"></asp:Label>
    </p>
    <p>
    ...
    <br />
    <p>
        <asp:Label ID="QuantityToBuyLabel" runat="server" Text="Quantity To Buy:" Font-Bold="True"></asp:Label>
        <asp:TextBox ID="QuantityToBuyTextBox" runat="server" Width="45px"></asp:TextBox>
        <asp:RequiredFieldValidator runat="server" id="requiredQuantityToBuy" controltovalidate="QuantityToBuyTextBox" errormessage="Please enter Quantity to buy" />
        <asp:CompareValidator ID="intQuantityToBuy" runat="server" ControlToValidate="QuantityToBuyTextBox" Type="Integer" Operator="DataTypeCheck" ErrorMessage="Please enter a whole number for the Quantity"></asp:CompareValidator>
    </p>
    <p>
    ...
    <p>
        <asp:Button ID="ConfirmPurchaseButton" runat="server" Text="Confirm" OnClick="ConfirmPurchaseButton_Click" Visible="false"></asp:Button>
    </p>
